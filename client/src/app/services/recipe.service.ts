...
export class RecipeService {
  ...
  private LIST_CUISINE_URI: string = `${BASE_URL}/api/list/cuisine`;
  private LIST_DIET_URI: string = `${BASE_URL}/api/list/diet`;
  private LIST_INGREDIENTS_URI: string = `${BASE_URL}/api/list/ingredients`;
  private LIST_NUTRIENTS_URI: string = `${BASE_URL}/api/list/nutrients`;
  private SAVE_RECIPE_URI: string = `${BASE_URL}/api/saverecipes`;
